...
Memori supports SQLite, PostgreSQL, MySQL, MariaDB, TiDB, Oracle, MongoDB, CockroachDB, and OceanBase. Managed services like Neon, Supabase, and AWS RDS/Aurora work through their compatible PostgreSQL/MySQL engines. Install the driver for your preferred database:
...
| ---------- | ----------------------------------------------- | --------------------------------------------------------------------- |
| SQLAlchemy | `sessionmaker`                                  | SQLite, PostgreSQL, MySQL, MariaDB, TiDB, Oracle, CockroachDB, OceanBase |
